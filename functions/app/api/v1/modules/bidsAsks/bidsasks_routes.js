module.exports = function (router) {
  ...
  router.post(
    "/bidsasks/createbidsorask",
    middlewares,
    bidsasks.createbidsorask
  );
  router.post(
    "/bidsasks/getAllBidAndAsks",
    middlewares,
    bidsasks.getAllBidAndAsks
  );
  router.post(
    "/bidsasks/getAllMybidOrAsk",
    middlewares,
    bidsasks.getAllMybidOrAsk
  );
  router.post(
    "/bidsasks/getHighestBidLowestAsk",
    middlewares,
    bidsasks.getHighestBidLowestAsk
  );
  router.post("/bidsasks/getfilterData", middlewares, bidsasks.getfilterData);
  router.post(
    "/bidsasks/getListingSearch",
    middlewares,
    bidsasks.getListingSearch
  );
  router.post(
    "/bidsasks/getHighestBidOrMinAsk",
    middlewares,
    bidsasks.getHighestBidOrMinAsk
  );
  ...
  router.post(
    "/bidsasks/inactiveBidOrAsk",
    middlewares,
    bidsasks.inactiveBidOrAsk
  );
  router.post("/bidsasks/updateMyAsk", middlewares, bidsasks.updateMyAsk);
  router.post(
    "/bidsasks/inactiveAllBidOrAsk",
    middlewares,
    bidsasks.inactiveAllBidOrAsk
  );
  router.post(
    "/bidsasks/deleteAllBidOrAsk",
    middlewares,
    bidsasks.deleteAllBidOrAsk
  );
  ...
  router.post(
    "/bidsasks/deleteListingBidOrAsk",
    middlewares,
    bidsasks.deleteListingBidOrAsk
  );
  router.post(
    "/bidsasks/inactiveListingBidOrAsk",
    middlewares,
    bidsasks.inactiveListingBidOrAsk
  );
  router.post(
    "/bidsasks/getlistingfilterData",
    middlewares,
    bidsasks.getlistingfilterData
  );
  router.post(
    "/bidsasks/getUserProfilelistingfilter",
    middlewares,
    bidsasks.getUserProfilelistingfilter
  );
  ...
  router.post(
    "/bidsasks/getUserFeedback",
    middlewares,
    bidsasks.getUserFeedback
  );
  router.post(
    "/bidsasks/updateBidAndAsk",
    middlewares,
    bidsasks.updateBidAndAsk
  );
