      ...
      socket.on('sendmsg', async (data) => {
        ...
        if (data.room_id) {
          if (data.type == 'table' || data.type == 'text' || data.type == 'email') {
            ...
            console.log('contact_idcontact_idcontact_id 1111111111111111', userId2, 'userId2[0].my_contact_id');
            ...
            socket.broadcast.to(socket.room).emit('receive', {
              data: data.msg,
              userid_of_my_contact: data.my_id,
              type: data.type,
              room_id: data.room_id,
            });
          ...
          console.log('contact_idcontact_idcontact_id', userId2, 'userId2[0].my_contact_id');
          if (data.type == 'table' || data.type == 'text' || data.type == 'email') {
            const chatData = {
              my_id: parseInt(data.my_id),
