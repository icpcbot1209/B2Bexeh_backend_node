module.exports = function (router) {
  ...
  router.post(
    "/user/getActiveOfferByUserId",
    middlewares,
    user.getActiveOfferByUserId
  );
  router.post(
    "/user/getActiveRecievedByUserId",
    middlewares,
    user.getActiveRecievedByUserId
  );

  router.post(
    "/user/getAcceptOfferByUserId",
    middlewares,
    user1.getAcceptOfferByUserId
  );
  router.post(
    "/user/getRecievedOfferByUserId",
    middlewares,
    user1.getRecievedOffers
  );
  router.post("/user/getSentOfferByUserId", middlewares, user1.getSentOffers);
  router.post(
    "/user/getClosedOfferByUserId",
    middlewares,
    user1.getClosedOfferByUserId
  );

  router.post(
    "/user/getSentAcceptOfferByUserId",
    middlewares,
    user.getSentAcceptOfferByUserId
  );
  router.post(
    "/user/getPendingOfferByUserId",
    middlewares,
    user.getPendingOfferByUserId
  );
